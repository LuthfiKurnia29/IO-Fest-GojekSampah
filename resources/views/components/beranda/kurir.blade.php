<div style="padding: 32px; background-color: #f8fafc;">
    <div class="mb-5">
        <span class="badge rounded-pill px-3 py-2 mb-3" style="background-color: #f0fdf4; color: #166534; border: 1px solid #dcfce7;">
            <i class="bi bi-stars me-1"></i> Selamat Datang, Kurir!
        </span>
        <h1 class="fw-bold" style="color: #064e3b; font-size: 2.5rem;">Halo, {{ Auth::user()->name }}</h1>
        <p class="text-secondary fs-5">
            Senang melihat Anda kembali. Anda memiliki <span class="fw-bold text-dark">4 tugas penjemputan</span> yang perlu diselesaikan hari ini. Tetap aman di jalan!
        </p>
    </div>

    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold mb-0" style="color: #134e4a;">
            <i class="bi bi-clipboard-check me-2 text-success"></i> Tugas Penjemputan Aktif
        </h4>
    ...
    <div class="row g-4">
        <div class="col-12 col-xl-6">
            <div class="card border-0 shadow-sm p-4 rounded-4 position-relative">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div class="d-flex align-items-center">
                        <img src="https://ui-avatars.com/api/?name=Siti+Aminah&background=2d3748&color=fff" class="rounded-circle me-3" width="56" height="56" alt="Siti">
                        <div>
                            <h5 class="fw-bold mb-0">Siti Aminah</h5>
                            <small class="text-secondary">ID Pelanggan: #9901</small>
                        </div>
                    </div>
                    <span class="badge px-3 py-2 rounded-pill" style="background-color: #ffedd5; color: #9a3412;">Prioritas</span>
                </div>

                <p class="text-secondary mb-4 d-flex align-items-start gap-2">
                    <i class="bi bi-geo-alt-fill text-muted"></i>
                    Jl. Melati No. 45, Kebon Jeruk, Jakarta Barat
                </p>

                <div class="row g-3 mb-4">
                    <div class="col-6">
                        <div class="p-3 rounded-3" style="background-color: #f5f3ff;">
                            <label class="text-secondary text-uppercase mb-1 fw-bold" style="font-size: 0.65rem; letter-spacing: 0.5px;">Jenis Sampah</label>
                            <div class="d-flex align-items-center gap-2">
                                <span class="rounded-circle bg-primary" style="width: 8px; height: 8px;"></span>
                                <span class="fw-bold small">Plastik & Botol</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="p-3 rounded-3" style="background-color: #f5f3ff;">
                            <label class="text-secondary text-uppercase mb-1 fw-bold" style="font-size: 0.65rem; letter-spacing: 0.5px;">Estimasi Berat</label>
                            <div class="d-flex align-items-center gap-2">
                                <i class="bi bi-hourglass-split text-dark"></i>
                                <span class="fw-bold small">5.2 kg</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-12 col-xl-6">
            <div class="card border-0 shadow-sm p-4 rounded-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div class="d-flex align-items-center">
                        <img src="https://ui-avatars.com/api/?name=Agus+Prasetyo&background=1a202c&color=fff" class="rounded-circle me-3" width="56" height="56" alt="Agus">
                        <div>
                            <h5 class="fw-bold mb-0">Agus Prasetyo</h5>
                            <small class="text-secondary">ID Pelanggan: #9924</small>
                        </div>
                    </div>
                    <span class="badge px-3 py-2 rounded-pill" style="background-color: #f1f5f9; color: #475569;">Reguler</span>
                </div>

                <p class="text-secondary mb-4 d-flex align-items-start gap-2">
                    <i class="bi bi-geo-alt-fill text-muted"></i>
                    Apartemen Central Park, Tower B Lantai 12
                </p>
                    ...
                    <div class="col-6">
                        <div class="p-3 rounded-3" style="background-color: #f5f3ff;">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <span class="fw-bold small">Kertas & Karton</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="p-3 rounded-3" style="background-color: #f5f3ff;">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <i class="bi bi-hourglass-split text-dark"></i>
                                <span class="fw-bold small">12.8 kg</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        @foreach(['Maya Indah' => '#9882', 'Nidzom' => '#5990'] as $name => $id)
        <div class="col-12 col-xl-6">
            <div class="card border-0 shadow-sm p-4 rounded-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div class="d-flex align-items-center">
                        <img src="https://ui-avatars.com/api/?name={{ urlencode($name) }}&background=random" class="rounded-circle me-3" width="56" height="56" alt="User">
                        <div>
                            <h5 class="fw-bold mb-0">{{ $name }}</h5>
                            <small class="text-secondary">ID Pelanggan: {{ $id }}</small>
                        </div>
                    </div>
                    <span class="badge px-3 py-2 rounded-pill" style="background-color: #f1f5f9; color: #475569;">Reguler</span>
                </div>
                ...
                <p class="text-secondary mb-4 d-flex align-items-start gap-2">
                    <i class="bi bi-geo-alt-fill text-muted"></i>
                    Gg. {{ $name == 'Maya Indah' ? 'Haji Umar' : 'Cinta Sejati' }} No. 12, Palmerah
                </p>
                    ...
                    <div class="col-6">
                        <div class="p-3 rounded-3" style="background-color: #f5f3ff;">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <span class="fw-bold small">Organik</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="p-3 rounded-3" style="background-color: #f5f3ff;">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <i class="bi bi-hourglass-split text-dark"></i>
                                <span class="fw-bold small">3.5 kg</span>
                            </div>
                        </div>
                    </div>
                </div>
